...
\cvsummary{
  \textbf{Senior Software Engineer} and naturalized \textbf{Swedish} citizen of \textbf{Indian} origin with over \textit{9 years} of experience in \textit{building} scalable web applications and \textit{leading} development teams.
